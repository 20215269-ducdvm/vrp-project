...
Usage:
    hsa.py <_problem_instance> --hms=<hms> --hmcr=<hmcr> --parmax=<par> --parmin=<parmin> --ni=<ni>
...
def get_vehicle_number_and_capacity(lines):
    # in Solomon instances all the vehicles have the same capacity
...
def parse_problem_lines(lines):
    ...
    problem_instance['type'] = get_problem_name(lines)
    ...
    # t is travel time matrix t[0.._location_number][0.._location_number]
    ...
    # s[i] is service _duration of consumer c[i]
