...
from datastructure.segment.DistanceSegment import Distance
...
class TestMergeSegment(unittest.TestCase):
    ...
    def test_merge_inter_route(self):
        ...
        distance_segment_route1 = proposal_for_route1.distance_segment
        distance_segment_route2 = proposal_for_route2.distance_segment

        assert distance_segment_route1.distance + distance_segment_route2.distance == Distance(1535)